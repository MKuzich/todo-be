...
var user_service_1 = __importDefault(require("cgs-team-boilerplate/user.service"));
var UserController = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        id = req.body._id;
                        return [4 /*yield*/, this.userService.logOut(id)];
                    case 1:
                        result = _a.sent();
    ...
    UserController.prototype.changePassword = function (req) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, id, password, result;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = req.body, id = _a.id, password = _a.password;
                        return [4 /*yield*/, this.userService.changePassword(id, password)];
                    case 1:
                        result = _b.sent();
                        return [2 /*return*/, result];
                }

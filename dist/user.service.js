...
var User_1 = __importDefault(require("./packages/backend/src/models/User"));
var errors_1 = require("./packages/backend/src/helpers/errors");
    ...
    UserService.authenticate = function (token) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        id = jsonwebtoken_1.default.verify(token, JWT_SECRET);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        user = _a.sent();
                        token = jsonwebtoken_1.default.sign(user._id, JWT_SECRET, { expiresIn: '1h' });
